...
export const createUser = async (userData) => {
    try {
        ...
        try {
            ...
            if (firestoreError.code === 'permission-denied') {
                return {
                    ...
                    message: 'Error de permisos en la base de datos. Verifica las reglas de Firestore.'
                };
            }
            ...
            return {
                ...
                message: 'Error al guardar en la base de datos: ' + firestoreError.message
            };
        }
        ...
        if (e.code === 'auth/email-already-in-use') {
            ...
            return { success: false, error: 'NETWORK_ERROR', message: 'Error de red. Verifica tu conexión.' };
        }
